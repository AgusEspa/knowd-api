...
public class Subject {
    ...
    public Subject(String title, String field, String area, Set<Topic> topics, Set<Relation> relations, int relevance, int progress, Status status, boolean needsAttention, LocalDate dueDate, UserEntity user) {
        this.title = title;
        this.field = field;
        this.area = area;
        this.topics = topics;
